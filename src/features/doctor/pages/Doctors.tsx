    ...
    <div className="Doctors">
      <div className="flex justify-between mt-5">
        <div className="ml-8 flex flex-col gap-3">
          ...
          <span><b className="font-bold text-black/70 mr-2">Showing:</b> All Consultations of All Healthcare Providers</span>
        </div>
        <div className="mr-8 flex gap-5 h-9 my-auto">
          <div className="border rounded-[10px] overflow-hidden w-[370px] flex">
            <input placeholder="Qidirish" className="w-[88%] h-full indent-4 outline-none " type="text" />
            <IoIosSearch className="text-[26px] my-auto ml-2"/>
          </div>
          <div className="border w-20 rounded-[10px] overflow-hidden flex items-center gap-2 pl-1">
